...
int readTTTRfile( Photons& photons, QVector<double> &markerTimePin4, QVector<double> &markerTimePin5, const QString filename, const Channel route0, const Marker Pin4, bool forceAlternation=false);
